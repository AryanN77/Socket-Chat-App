...
export const useChatStore = create((set, get) => ({
    ...
    getAllContacts: async () => {
        ...
        try {
            ...
            console.log("Res:", res.data.filteredUsers);
    ...
    getMyChatPartners: async () => {
        ...
        try {
            ...
            toast.error(error.res.data.message || "Error Fetching Chats");
        } finally {
            set({ isUsersLoading: false })
        }
    },
    getMessagesByUserId: async (userId) => {
        ...
        try {
            ...
            toast.error(error.res?.data.message || "Error Fetching Messages");
        } finally {
